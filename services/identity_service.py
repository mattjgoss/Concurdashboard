...
class IdentityService:
    ...
    - Uses injected api_base_url by default
    - Optional: can still read base URL from Key Vault if you want (use_keyvault_base_url=True)
    """
    ...
    def __init__(self, api_base_url: str, oauth: ConcurOAuthClient):
        ...
        if not self.api_base_url:
            raise ValueError("IdentityService requires api_base_url")
    ...
    def search_users(
        ...
        *,
        ...
        """
        base_url = concur_base_url() if use_keyvault_base_url else self.api_base_url
